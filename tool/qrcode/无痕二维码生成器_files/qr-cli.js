/*! For license information please see qr-cli.js.LICENSE.txt */
!(function (t, e) {
    ...
    return (
      (function () {
        ...
        var a = r(687),
                        ...
                        return (
                          ...
                          new Promise(function (t) {
                            var e = setInterval(function () {
                              window.__opencv && (clearInterval(e), t());
                            }, 83);
                          })
                        );
                      case 3:
                        ...
                        return (t.next = 6), window.__opencv();
                      case 6:
                        c = t.sent;
                      case 7:
          ...
          l = function (t) {
            for (var e = t.size(), r = [], n = 0; n < e; n++) r.push(t.get(n));
            return t.delete(), r;
          },
          p = ['', '', '', ''],
          h = (function () {
                                          ...
                                          switch ((i.prev = i.next)) {
                                            case 0:
                                              (i.prev = 0),
                                                ...
                                                (d = new o.MatVector()),
                                                (v = e(
                                                  o.wechat_qrcode_WeChatQRCode,
                                                  p
                                                )),
                                                (y = l(
                                                  v.detectAndDecode(s, d)
                                                )),
                                                t(y),
                                                (i.next = 26);
                                              break;
